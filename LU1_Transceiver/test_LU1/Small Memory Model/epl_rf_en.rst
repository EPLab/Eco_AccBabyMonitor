                              ...
                              4 ; This file was generated Tue Oct 26 13:20:49 2010
                              5 ;--------------------------------------------------------
                              6 	.module epl_rf_en
   ...
   0131 12 15 3E            565 	lcall	_hal_nrf_close_pipe
   ...
   013A 12 18 49            570 	lcall	_hal_nrf_set_datarate
   ...
   014A 90 80 EE            581 	mov	dptr,#_hal_nrf_set_auto_retr_PARM_2
   ...
   0154 12 16 32            588 	lcall	_hal_nrf_set_auto_retr
   ...
   015D 12 18 27            593 	lcall	_hal_nrf_set_output_power
   ...
   0166 12 14 63            598 	lcall	_hal_nrf_set_crc_mode
   ...
   01A4 90 80 E7            647 	mov	dptr,#_hal_nrf_open_pipe_PARM_2
   01A7 F0                  648 	movx	@dptr,a
   01A8 8A 82               649 	mov	dpl,r2
   01AA C0 02               650 	push	ar2
   01AC 12 14 87            651 	lcall	_hal_nrf_open_pipe
   ...
   01BC 90 80 EA            663 	mov	dptr,#_hal_nrf_set_address_PARM_2
   ...
   01CB 12 15 BE            674 	lcall	_hal_nrf_set_address
   ...
   01D4 90 80 F2            679 	mov	dptr,#_hal_nrf_set_rx_pload_width_PARM_2
   01D7 F0                  680 	movx	@dptr,a
   01D8 8A 82               681 	mov	dpl,r2
   01DA 02 16 7F            682 	ljmp	_hal_nrf_set_rx_pload_width
                            683 ;------------------------------------------------------------
   ...
   031F 12 39 EE            922 	lcall	__gptrget
   ...
   0333 12 39 EE            935 	lcall	__gptrget
   ...
   0347 12 39 EE            948 	lcall	__gptrget
   ...
   035B 12 39 EE            961 	lcall	__gptrget
   035E F8                  962 	mov	r0,a
   035F A3                  963 	inc	dptr
   0360 12 39 EE            964 	lcall	__gptrget
   ...
   0373 12 39 EE            977 	lcall	__gptrget
   ...
   0387 12 39 EE            990 	lcall	__gptrget
   ...
   0405 12 39 EE           1065 	lcall	__gptrget
   ...
   0416 12 39 EE           1077 	lcall	__gptrget
   ...
   043D 02 17 9F           1109 	ljmp	_hal_nrf_set_operation_mode
                           1110 ;------------------------------------------------------------
   ...
   0445 02 17 9F           1123 	ljmp	_hal_nrf_set_operation_mode
                           1124 ;------------------------------------------------------------
   ...
   0463 90 80 EA           1155 	mov	dptr,#_hal_nrf_set_address_PARM_2
   ...
   0471 02 15 BE           1165 	ljmp	_hal_nrf_set_address
                           1166 ;------------------------------------------------------------
   ...
   048F 90 80 EA           1200 	mov	dptr,#_hal_nrf_set_address_PARM_2
   ...
   049D 12 15 BE           1210 	lcall	_hal_nrf_set_address
   ...
   04B2 90 80 FF           1225 	mov	dptr,#_hal_nrf_write_tx_pload_PARM_2
   04B5 F0                 1226 	movx	@dptr,a
   04B6 8A 82              1227 	mov	dpl,r2
   04B8 8B 83              1228 	mov	dph,r3
   04BA 8C F0              1229 	mov	b,r4
   04BC 12 19 3D           1230 	lcall	_hal_nrf_write_tx_pload
   ...
   04EE 90 80 FF           1278 	mov	dptr,#_hal_nrf_write_tx_pload_PARM_2
   04F1 F0                 1279 	movx	@dptr,a
   04F2 8A 82              1280 	mov	dpl,r2
   04F4 8B 83              1281 	mov	dph,r3
   04F6 8C F0              1282 	mov	b,r4
   04F8 12 19 3D           1283 	lcall	_hal_nrf_write_tx_pload
   ...
   0508 12 19 10           1305 	lcall	_hal_nrf_get_rx_fifo_status
   ...
   0539 02 1A 95           1350 	ljmp	_hal_nrf_read_rx_pload
                           1351 ;------------------------------------------------------------
   ...
   0567 02 1A 95           1392 	ljmp	_hal_nrf_read_rx_pload
                           1393 	.area CSEG    (CODE)
